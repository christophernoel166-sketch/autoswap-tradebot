...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes. Autoswaps can detect contract addresses posted in supported Telegram channels. When a signal appears, the system loads users subscribed to that channel, checks which users enabled trading, applies each user’s settings, executes the trade, monitors the position, and sells based on each user’s take-profit and stop-loss rules.",
    },
    {
      q: "Can I add my own Telegram channel to the bot?",
      a: "Yes. Channel owners can onboard their Telegram channel into Autoswaps. Once onboarded, subscribers who enable trading can have trades executed automatically based on signals posted in the channel.",
    },
    {
      q: "Can other users steal my signals if I add my channel?",
      a: "No. Autoswaps includes access control for channel owners. Users who are not approved subscribers cannot trade your channel signals without permission.",
    },
    {
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="text-gray-300 text-lg mb-10">
          ...
          conditions, Telegram signal trading, channel onboarding, and chart
          analysis.
        </p>
